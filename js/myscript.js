function swap(imgnum){
	...
	switch(imgnum)
	{
        ...
        document.getElementById("textColumn").style.backgroundColor = "magenta"; 
    /*document.getElementById("changeText").style.backgroundColor = "pink"; */
        ...
        document.getElementById("textColumn").style.backgroundColor = "lime";
        ...
        for (i=0;i<x.length;i++)
            {
                x[i].style.backgroundColor = "lime";
            }    
        break;    
