function swap(imgnum){
	...
	switch(imgnum)
	{
        ...
        document.getElementById("textColumn").style.color = "orange"; 
        ...
        document.getElementById("textColumn").style.color = "pink"; 
        break;
        ...
        document.getElementById("textColumn").style.color = "lightgreen"; 
        break;
